...
func NewArticleHandler(e *echo.Echo, usecase domain.ArticleUsecase) {
	...
	article.GET("/all", handler.GetArticleAllHandler)
}

func (a articleHandler) GetArticleAllHandler(e echo.Context) error {
	...
	res, err := a.articleUsecase.Fetch(ctx, limit, offset)
